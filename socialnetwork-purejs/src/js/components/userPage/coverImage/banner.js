    ...
    html: /*html*/`
      ...
      <div id="profile-upper">
        ...
        <div id="profile-d">
          ...
          <div class="mt-1">
            <friend-request-template id="friendRequestTemplate" userId="${data.id}" ${data.friendStatus ? `data=${JSON.stringify(data.friendStatus)}` : ""}></friend-request-template>
          </div>
        </div>
      </div>
    `,
